...
- Keep Vaadin views and REST controllers behind service methods. Do not inject repositories into UI components.
- Use DTO/projection queries for grids, search results, and dashboards.
- Add indexes in migrations for fields used by filters, joins, sorting, and foreign keys.
- Avoid `Open Session in View`; design service methods to load the data the UI needs.
