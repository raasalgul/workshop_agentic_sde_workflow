...
Use WebFlux only when the project already uses reactive stacks or the issue explicitly requires non-blocking I/O. For classic Vaadin Flow or Spring MVC apps, use imperative Spring services and JPA.
